...
FINAL_ZIP=Perf+-${DEVICE}-KERNEL-${TM}.zip
...
function cloneTC() {
	...
	case $COMPILER in
		...
		*)
		...
		rm -rf AnyKernel3
		if [ "${DEVICE}" = "alioth" ]; then
          git clone --depth=1 https://github.com/AnkitSavani111/AnyKernel3 -b alioth AnyKernel3
        elif [ "${DEVICE}" = "apollo" ]; then
          git clone --depth=1 https://github.com/AnkitSavani111/AnyKernel3 -b apollo AnyKernel3
        elif [ "${DEVICE}" = "munch" ]; then
          git clone --depth=1 https://github.com/AnkitSavani111/AnyKernel3 -b munch AnyKernel3
		elif [ "${DEVICE}" = "cas" ]; then
          git clone --depth=1 https://github.com/AnkitSavani111/AnyKernel3 -b cas AnyKernel3
		elif [ "${DEVICE}" = "cmi" ]; then
          git clone --depth=1 https://github.com/AnkitSavani111/AnyKernel3 -b cmi AnyKernel3
		elif [ "${DEVICE}" = "umi" ]; then
          git clone --depth=1 https://github.com/AnkitSavani111/AnyKernel3 -b umi AnyKernel3
		else
		  git clone --depth=1 https://github.com/AnkitSavani111/AnyKernel3 -b lmi AnyKernel3
		fi
	}
...
function exports() {
        ...
        export KBUILD_BUILD_USER="AnkitSavani"
